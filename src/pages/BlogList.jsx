        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[35px] max-w-full mq750:gap-[17px]">
          ...
          >
            ...
            <div className="ml-[-5px] w-[364.1px] flex flex-row items-start justify-start py-0 pr-5 pl-0 box-border gap-[12.1px] max-w-full mq450:flex-wrap">
              ...
              >
                <button className="cursor-pointer py-[5px] pr-[9px] pl-[11px] bg-palegreen flex-1 rounded-81xl flex flex-row items-start justify-start whitespace-nowrap border-[1px] border-solid border-coral hover:bg-forestgreen hover:box-border hover:border-[1px] hover:border-solid hover:border-chocolate-200">
                  <div className="relative text-smi font-medium font-lexend-deca text-coral text-left inline-block min-w-[76px]">
                    Post Details
                  </div>
                </button>
              </div>
